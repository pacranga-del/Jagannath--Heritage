  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
      ...
      <form
        ...
        className="lg:col-span-5 border border-stone-800 p-6 md:p-8 bg-stone-950/60 space-y-6 h-fit lg:sticky lg:top-24"
      >
        <div>
          <p className="text-[11px] uppercase tracking-eyebrow text-[#D4AF37] mb-3">Photograph</p>
      ...
      <div className="lg:col-span-7">
        <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
          <p className="text-[11px] uppercase tracking-eyebrow text-stone-400">
            In archive · <span className="text-[#D4AF37]">{photos.length}</span>
          </p>
